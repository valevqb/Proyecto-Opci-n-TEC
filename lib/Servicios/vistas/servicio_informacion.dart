...
class _InformacionServicioState extends State<InformacionServicio> {
  ...
  Widget tituloImagenPrincipal(BuildContext context, servicioSeleccion) {
  ...
  Widget informacionServicio(BuildContext context, servicioSeleccion) {
    ...
    return Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              servicioSeleccion.Nombre, //Nombre del servicio
              style: TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 18,
          ...
          Container(
            ...
            child: Text(
              servicioSeleccion.Descripcion, //Labor del servicio
              style: TextStyle(
                  fontFamily: 'Mulish',
                  fontSize: 14,
                  fontWeight: FontWeight.bold),
